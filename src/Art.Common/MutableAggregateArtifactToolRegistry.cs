...
/// </summary>
/// <remarks>
/// TryGetType, TryLoad, and TryIdentify use LIFO order for registries.
/// Contains and GetToolDescriptions uses FIFO order for registries.
/// </remarks>
public class MutableAggregateArtifactToolRegistry : IArtifactToolSelectableRegistry<string>
{
    /// <summary>
    ...
    /// <inheritdoc />
    /// <remarks>
    /// This method uses LIFO order for the underlying registries.
    /// </remarks>
